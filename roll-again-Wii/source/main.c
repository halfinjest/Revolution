...
int main()
{
	...
	while (true)
	{
		...
		else if (button & WPAD_BUTTON_DOWN && dice[place] >= 1)
			dice[place]--;
		...
		else if (button & WPAD_BUTTON_LEFT && place > 0)
			place--;
		...
		else if (button & WPAD_BUTTON_RIGHT && place < count - 1)
			place++;

		else if (button & WPAD_BUTTON_UP && dice[place] < 6)
			dice[place]++;
